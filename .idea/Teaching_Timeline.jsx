    ...
    return (
        <div className="flex h-screen bg-black overflow-hidden font-sans">
            ...
            <div className="flex-1 overflow-y-auto p-8 flex flex-col gap-12 scroll-smooth">
                ...
                <div className="sticky top-0 z-10 flex justify-between items-center bg-black/80 backdrop-blur-md pb-4 border-b border-gray-800">
                    ...
                    <div className="flex gap-4">
                        ...
                        <span className="text-emerald-400 font-mono text-sm border border-emerald-900/50 bg-emerald-900/20 px-3 py-1 rounded-full">Score: {blocks.length * 50}</span>
                    </div>
                </div>
